...
describe('mergeConfigs', async (assert: any) => {
...

  {
    const overrideValues = {
      ...
      VAULT_URL: 'override',
      MONGODB_SCHEMA: 'override',
      MONGODB_USER: 'override',
      MONGODB_PASSWORD: 'override',
      MONGODB_HOST: 'override',
      MONGODB_PORT: 777,
      MONGODB_DATABASE: 'override',
    ...
    const expected = {
      vaultToken: 'override',
      vaultUrl: 'override',
      mongodbSchema: 'override',
      mongodbUser: 'override',
      mongodbPassword: 'override',
      mongodbHost: 'override',
      mongodbPort: 777,
